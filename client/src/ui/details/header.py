...
TECHNICAL DEBT:
    - Добавить иконку в зависимости от типа узла
    - Добавить цветовую индикацию статуса (зелёный — активен, красный — неактивен, жёлтый — ожидание)
"""
...
class HeaderWidget(QWidget):
    ...
    TECHNICAL DEBT:
        - Добавить иконку для каждого типа узла (COMPLEX, BUILDING, FLOOR, ROOM)
        - Добавить цветовую индикацию статуса
    """
